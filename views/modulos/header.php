...
<head>
    ...
    <!-- Custom CSS -->
    <link href="views/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="views/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css" rel="stylesheet">
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="views/assets/images/users/profile.png" alt="user" class="rounded-circle" width="31">
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i class="ti-wallet m-r-5 m-l-5"></i>
                                    Balance</a>
                                <a class="dropdown-item" href="salir"><i class="mdi-logout m-r-5 m-l-5"></i>
                                    salir</a>
                            </ul>
                        </li>
                        <!-- ============================================================== -->
